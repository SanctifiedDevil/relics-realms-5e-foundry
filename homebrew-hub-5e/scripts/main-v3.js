...
class HHImporter {
  ...
  static mapWeapon(base, d) {
    ...
    // If magical bonus, add mgc property
    if (d.magical_bonus && d.magical_bonus > 0) props.add("mgc");
    return foundry.utils.mergeObject(base, {
      system: {
        description: {
          value: (base.system?.description?.value || "") +
            (d.special_effects ? `<p><strong>Special:</strong> ${d.special_effects}</p>` : ""),
        },
        quantity: 1,
        ...
        proficient: 1,
        type: {
          value: d.weapon_type || "simpleM",
          baseItem: d.weapon_type || "",
        },
        damage: {
          base: {
